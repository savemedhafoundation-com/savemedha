...
const TreatmentBadge = ({
  ...
  baseShadow,
  hoverColor = "#3c6513",
  hoverShadow = "rgba(60,101,19,0.25)",
  href,
}) => {
  ...
  return (
    <a
      ...
      className="inline-flex items-center justify-center px-14 py-4 text-2xl font-semibold italic text-white transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#3c6513] focus-visible:ring-offset-white"
      style={{
...
export default function SMALearnMore({ smaKey, onNavigate, fallbackTitle }) {
  const detail = getSMADetail(smaKey, fallbackTitle);
