...
const LOCATIONS = [
  {
    ...
    phone: "+91-9800808595",
    mapLink: "https://www.google.com/maps/place/SAVE+MEDHA+FOUNDATION/@24.4638945,88.0617446,21z/data=!4m6!3m5!1s0x39fa37b3ddfe5de3:0xa89ed48bed496e9c!8m2!3d24.4639024!4d88.0621392!16s%2Fg%2F11pldtpkhx?entry=ttu&g_ep=EgoyMDI1MTExNy4wIKXMDSoASAFQAw%3D%3D",
    lat: 24.4639,
    lng: 88.0621,
  },
  {
    ...
    phone: "+91-9800808595",
    mapLink: "https://www.google.com/maps/place/SAVE+MEDHA+FOUNDATION+(Kandi)/@23.9659375,88.0366875,19z/data=!3m1!4b1!4m6!3m5!1s0x39f98500654daeb3:0x58de039a2d6f8d8f!8m2!3d23.9659375!4d88.0366875!16s%2Fg%2F11y3sjt7_0?entry=ttu&g_ep=EgoyMDI1MTExNy4wIKXMDSoASAFQAw%3D%3D",
    lat: 23.9659,
    lng: 88.0367,
  },
  {
    ...
    phone: "+91-9800808595",
    mapLink: "https://www.google.com/maps/place/Save+Medha+Foundation,+Jalangi+Murshidabad/@24.1192108,88.6489302,19z/data=!3m1!4b1!4m6!3m5!1s0x39f957001b2532a7:0xe51ce0dcd5837374!8m2!3d24.1192108!4d88.6495753!16s%2Fg%2F11wn18hn54?entry=tts&g_ep=EgoyMDI1MDEwOC4wIPu8ASoASAFQAw%3D%3D",
    lat: 24.1192,
    lng: 88.6496,
  },
  {
  ...
  },
  {
    ...
    phone: "+91-9800808595",
    mapLink: "https://www.google.com/maps/place/SAVE+MEDHA+FOUNDATION/@22.6565535,88.3768677,20z/data=!4m6!3m5!1s0x39f89d000952858d:0x6a6a8a1fea1a20cc!8m2!3d22.6564235!4d88.3772227!16s%2Fg%2F11vyh_tw_r?entry=ttu&g_ep=EgoyMDI1MTExNy4wIKXMDSoASAFQAw%3D%3D",
    lat: 22.6564,
    lng: 88.3772,
  },
  {
    ...
    phone: "+91-9800808595",
    mapLink: "https://www.google.com/maps/place/Save+Medha+Foundation,+Fulbari/@26.3645737,88.0784624,10z/data=!4m6!3m5!1s0x39e44300776c4c55:0x2e0e3d31f99341a5!8m2!3d26.6455949!4d88.4169501!16s%2Fg%2F11w3rwk99w?entry=ttu&g_ep=EgoyMDI1MTExNy4wIKXMDSoASAFQAw%3D%3D",
    lat: 26.6456,
    lng: 88.4170,
  },
  {
    city: "MUMBAI",
    address: "Pathik Guest House, Acharya Donde Marg, behind Tata Memorial Center, Mumbai - 400012",
    phone: "+91-9800808595",
    mapLink: "https://www.google.com/maps/place/SAVE+MEDHA+FOUNDATION/@18.9364496,72.8061688,14z/data=!4m6!3m5!1s0x3be7d19f1391824d:0x37b77663608d6140!8m2!3d18.9364508!4d72.8364176!16s%2Fg%2F11wx5p4z0s?entry=ttu&g_ep=EgoyMDI1MTExNy4wIKXMDSoASAFQAw%3D%3D",
    lat: 18.9365,
    lng: 72.8364,
  },
];
...
export default function LocateUs({ onNavigate }) {
  ...
  const openMap = (link) => {
    if (link) {
      ...
      window.open(`https://www.google.com/maps/search/Save+Medha+Foundation+Rongpur+Bangladesh`, "_blank", "noopener,noreferrer");
    }
  };
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-center text-gray-800 mb-12 relative">
            <div className="flex justify-center items-center gap-2">
              <span>Address</span>
              <span><ImLocation className="text-[#003399] size-9" /></span>
            </div> 
          ...
          <div className="text-center mb-10">
            ...
            >
              <MdMyLocation className={detecting ? "animate-pulse" : ""} size={20} />
            ...
            {LOCATIONS.map((loc, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    Location
                    <GoPin className="text-lg font-bold" color="#E7581F" size={20} />
                  </button>
                </div>
              );
            })}
